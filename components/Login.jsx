...
const Button = () => {
  ...
  return (
    <>
      <button
        type="button"
        className="flex bg-gray-800 text-white px-4 py-3 rounded-xl hover:bg-gray-900"
      ...
      {authError && (
        <div className="absolute top-2 bg-red-700 text-white px-4 py-3 rounded-xl shadow-lg ">
          <h1 className="font-semibold">{authError.message}</h1>
        </div>
      )}
    </>
  );
